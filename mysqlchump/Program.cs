...
class Program
{
	...
	{
		var rootCommand = new RootCommand("MySQLChump data transfer tool v1.6");
		...
		var importCommand = new Command("import", "Imports data to a database")
		{
			...
			upgradeTokuDbOption, sourceTablesOption, deferIndexesOption, stripIndexesOption
		};
